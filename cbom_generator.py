...
def generate_cbom(scan_results: List[Dict[str, Any]]) -> CBOM:
    ...
    for endpoint in cbom.endpoints:
        ...
        detected_algs = [asset.name for asset in endpoint.assets]
        endpoint.pqc_certificate = issue_certificate(endpoint.endpoint, endpoint.pqc_ready, endpoint.weak_crypto_detected, detected_algs)
